...
<body class="container">
  ...
  try {
            ...
            $con = connectDB();
            $query = "SELECT Bike_Dimension.BikeModel,COUNT(BookingID) as numberOfBikes from Booking_Fact,Bike_Dimension where Booking_Fact.BikeKey=Bike_Dimension.BikeKey GROUP BY Bike_Dimension.BikeModel";
