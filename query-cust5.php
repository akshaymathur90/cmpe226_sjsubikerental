...
<body class="container">
  ...
  try {
            ...
            $con = connectDB();
            $query = "SELECT Bike_Dimension.Location,Calendar_Dimension.Year,Customer_dimension.Name, COUNT(BookingID) as numberOfBikes
                        from Booking_Fact,Calendar_Dimension,Bike_Dimension,Customer_dimension
                        where Booking_Fact.CalendarKey=Calendar_Dimension.CalendarKey
                         -- and Booking_Fact.BikeKey=Bike_Dimension.BikeKey 
                         and Booking_Fact.Customerkey = Customer_dimension.CustomerKey
                         GROUP BY Bike_Dimension.Location,Calendar_Dimension.Year,Customer_dimension.Name ";
